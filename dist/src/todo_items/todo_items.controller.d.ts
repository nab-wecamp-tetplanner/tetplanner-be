...
export declare class TodoItemsController {
    ...
    upsertSubtask(req: any, id: string, dto: UpsertSubtaskDto): Promise<import("./entities/todo_item.entity").TodoItem>;
    removeSubtask(req: any, id: string, dto: RemoveSubtaskDto): Promise<import("./entities/todo_item.entity").TodoItem>;
